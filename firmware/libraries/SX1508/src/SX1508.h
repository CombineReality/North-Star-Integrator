...
https://github.com/sparkfun/SparkFun_SX1508_Arduino_Library
...
private:	// These private functions are not available to Arduino sketches.
	...
	byte deviceAddress; // I2C Address of SX1508
// Pin definitions:
	byte pinInterrupt;
	byte pinOscillator;
	byte pinReset;
...
// begin function:
	SX1508(byte address, byte resetPin = 255, byte interruptPin = 255, byte oscillatorPin = 255); 
...
// -----------------------------------------------------------------------------
// begin(byte address, byte resetPin): This function initializes the SX1508.
...
// -----------------------------------------------------------------------------
	...
	void configForNorthStarButtons();
	byte readData();
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// pinMode(byte pin, byte inOut): This function sets one of the SX1508's 16 
...
// -----------------------------------------------------------------------------
	byte readKeypad();
	byte readKeyData(); // Legacy: use readKeypad();
...
// -----------------------------------------------------------------------------
// debouncePin(byte pin): This method enables debounce on SX1508 input pin.
//
//	Input:
...
// -----------------------------------------------------------------------------
	byte interruptSource(bool clear = true);
...
// Add backwards compatibility for the old class name: SX1508Class
